          ...
          <div className=" table-container h-[90%] overflow-y-auto">
            <table className="w-full">
              <thead className="bg-white text-gray-900 sticky top-0 shadow-md uppercase">
                <tr>
                  <th className="py-2 px-4 text-left hidden sm:table-cell text-xs sm:text-sm">SNo.</th>
              ...
              <tbody>
                {allCustomer.map((order, index) => (
                  ...
                  >
                    <td className="py-2 px-4 font-semibold hidden sm:table-cell text-xs sm:text-sm">{index + 1}</td>
