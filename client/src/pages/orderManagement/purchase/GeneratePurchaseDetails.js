...
const GeneratePurchaseDetails = () => {
  ...
  return (
    ...
    <div className="flex justify-between px-4 py-2 bg-gray-100 shadow">
      ...
      <span className="cursor-pointer" onClick={() => handleOnGeneratePurchase()}>Generate Purchase</span>
    ...
    <div className="m-10 border" id="printableArea">
      ...
      <div className="">
        <h3 className="bg-gray-300 w-60 px-5 py-1 uppercase">Customer Details</h3>
      </div>
      ...
      {/* recipe ordered  */}
      <div className="mt-4">
        <h3 className="bg-gray-300 w-60 px-5 py-1 uppercase">Recipe Ordered</h3>
      </div>
      <div className="mb-5">
      ...
      <div className="mt-10">
        <h3 className="bg-gray-300 w-60 px-5 py-1 uppercase">Required Ingredients</h3>
      </div>
