  ...
  return (
    <>
      <div className=" h-screen  border shadow-2xl bg-gray-50">
        ...
        <div className="bg-white mt-2 mx-8 p-4">
          <div className="uppercase font-bold text-start p-2 border-b">
            {" "}
            Beding details{" "}
          </div>
            <div className=" p-1 text-start font-bold border-b">
              Select Items
            </div>
          <div className="bg-white mt-2 rounded shadow-sm h-full">
            
              <div className="flex flex-row justify-evenly items-start text-xt font-bold mt-2 p-2">
            ...
            {/* items count */}
            <div className=" p-1 text-start font-bold ">
              Items Count
            </div>
              ...
              {selectedItems.map((item) => (
                ...
                >
                  ...
                  <input
                    ...
                    className="flex justify-evenly py-2 px-4 rounded border border-gray-300 focus:outline-none focus:border-blue-500"
                  />
                </div>
              ))}
            </div>
          ...
          <div className="h-full mt-8 text-center">
            <button
              onClick={handleNext}
              className="mb-2 select-none rounded-lg bg-gradient-to-tr from-gray-900 to-gray-800 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
            >
              Save & Next
            </button>
          </div>
