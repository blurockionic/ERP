...
const StepTwo = ({ nextStep, prevStep, tentItem }) => {
  ...
  return (
    <div className=" h-screen overflow-y-auto bg-gray-50">
      ...
      <div className="xl:ml-12 xl:mr-12 sm:mx-auto lg:mx-auto bg-white mt-2 rounded border">
        ...
        <div className="grid xl:grid-cols-2 gap-x-8 mb-4">
          <div className="mt-2 mx-auto flex justify-self-auto gap-4">
            <span
              htmlFor="chair"
              className=" w-[5rem] text-start font-normal text-gray-700 "
            >
              Chair:
            </span>
            <select
          ...
          <div className="mt-2  mx-auto flex justify-self-auto gap-4">
            ...
            >
              ...
              <option value="Green mat" className="text-center">
                Green mat{" "}
              </option>
              <option value="Black mat" className="text-center">
                Black mat{" "}
              </option>
              <option value="Red mat" className="text-center">
                Red mat{" "}
              </option>
              <option value="Golden mat" className="text-center">
                Golden mat{" "}
              </option>
            </select>
            <input
          ...
          <div className="mt-2   mx-auto flex justify-self-auto gap-4">
            ...
            >
              ...
              <option value="Counter" className="text-center">
                Counter
              </option>
            </select>
          ...
          <div className="mt-2  mx-auto flex justify-self-auto gap-4">
            ...
            >
              ...
              <option value="galiche" className="text-center">
                galiche
              </option>
            </select>
            <input
      ...
      {/* table  */}
      <div className="xl:ml-12 xl:mr-12 sm:mx-auto lg:mx-auto bg-white mt-2 rounded border">
        <h1 className="font-bold py-2 border-b px-2">Tables</h1>
      ...
      {/* decoration  */}
      <div className="xl:ml-12 xl:mr-12 sm:mx-auto lg:mx-auto bg-white mt-2 rounded border">
        <h1 className="font-bold py-2 border-b px-2">Tent Area</h1>
        {/* parent div  */}
        ...
        <div className="grid xl:grid-cols-2 gap-x-8 mb-4">
          ...
          <div className="mt-2  mx-auto flex justify-self-auto gap-4">
            ...
            >
              ...
              <option value="12 feet beam " className="text-center">
                {" "}
                12 Feet Beam{" "}
              </option>
              <option value="10feet beam" className="text-center">
                {" "}
                10 Feet Beam
              </option>
            </select>
          ...
          <div className="mt-2  mx-auto flex justify-self-auto gap-4">
            ...
            >
              ...
              <option value="12 feet pillar " className="text-center">
                {" "}
                12 Feet piller{" "}
              </option>
              <option value="10 feet pillar" className="text-center">
                {" "}
                10 Feetpiller
              </option>
            </select>
          ...
          <div className="mt-2  mx-auto flex justify-self-auto gap-4">
            ...
            >
              ...
              <option value="length" className="text-center">
                Lenght
              </option>
            </select>
            <input
          ...
          <div className="mt-2  mx-auto flex justify-self-auto gap-4">
            ...
            >
              ...
              <option value="paya" className="text-center">
                Paya
              </option>
            </select>
            <input
